...
<footer style="background-color: #f8f9fa; padding: 20px; text-align: center; font-family: Arial, sans-serif;">
    <p style="font-size: 14px; color: #6c757d;">Copyright &copy; <a href="#" style="color: #007bff; text-decoration: none;">TrendyShe</a></p>

    <form class="contact-form" action="#" method="post" style="margin: 10px 0;">
        <button type="button" onclick="window.location.href='mailto:mahimakela123@gmail.com'" 
                style="background-color: #007bff; color: #fff; border: none; border-radius: 5px; padding: 10px 15px; cursor: pointer; font-size: 14px; margin: 5px;">
            📧 Email: mahimakela123@gmail.com
        </button>
        <button type="button" onclick="window.location.href='tel:+917020859676'" 
                style="background-color: #28a745; color: #fff; border: none; border-radius: 5px; padding: 10px 15px; cursor: pointer; font-size: 14px; margin: 5px;">
            📞 Phone: +91 7020859676
        </button>
    </form>

    <div class="social-icons" style="margin: 15px 0;">
        <button onclick="window.location.href='https://www.linkedin.com/in/mahima-kela-376b5b259'" 
                style="background-color: #0077b5; color: #fff; border: none; border-radius: 5px; padding: 10px 15px; cursor: pointer; font-size: 14px; margin: 5px;">
            <i class="fab fa-linkedin-in" style="margin-right: 5px;"></i> LinkedIn
        </button>
        <button onclick="window.location.href='https://github.com/mahimakela'" 
                style="background-color: #333; color: #fff; border: none; border-radius: 5px; padding: 10px 15px; cursor: pointer; font-size: 14px; margin: 5px;">
